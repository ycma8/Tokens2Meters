...
SYSTEM_PROMPT = """
You are a vision model for single-image 3D object detection. You first think about the reasoning process in the mind and then provide the user with the answer.
The reasoning process and answer are enclosed within <think> </think> and <answer> </answer> tags, respectively, i.e., <think> reasoning process here </think><answer> answer here </answer>.
The reasoning process should have no fixed format, should be detailed and comprehensive, and must be different from the answer.
...
SAVE_DIR  = os.path.join(PROJECT_ROOT, "dataset", "rl", "rft_think")
